...
/**
 * Catégories d'activités (artistique, organisation, technique…) avec leur couleur.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * Activités planifiées du centre social.
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface Activite {
  ...
  heureFin: string;
  /**
   * Texte libre (ex. "Salle principale", "Cours arrière").
   */
  lieu: string;
  /**
   * Pseudo Signal ou email de contact.
   */
  organisateurs?: string | null;
  /**
   * Affichée dans la bulle du planning.
   */
...
/**
 * Équipes / groupes du centre social.
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "equipes".
 */
export interface Equipe {
  ...
  image?: (number | null) | Media;
  /**
   * Tri ascendant sur la page Équipes.
   */
  ordre?: number | null;
  updatedAt: string;
  createdAt: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "equipes_select".
 */
export interface EquipesSelect<T extends boolean = true> {
  nom?: T;
  slug?: T;
  descriptionCourte?: T;
  description?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "taches_select".
 */
export interface TachesSelect<T extends boolean = true> {
  titre?: T;
  description?: T;
  statut?: T;
  raisonBlocage?: T;
